...
import { Button, Text, YStack, ScrollView, H4, Paragraph, Separator } from "tamagui";
  ...
  return (
    <ScrollView bg="$background" f={1}>
      <YStack p="$4" space="$4">
        ...
        />
        <H4 ta="center" mb="$2">Pusat Bantuan</H4>
        ...
        <YStack space="$3" p="$3" borderRadius="$4" bg="$backgroundFocus" mt="$4">
          ...
          <Text>Email: <Text fontWeight="bold">dukungan@depotair.com</Text></Text>
          <Text>Telepon: <Text fontWeight="bold">(021) 123-4567</Text></Text>
        ...
        <YStack space="$3" p="$3" borderRadius="$4" bg="$backgroundFocus" mt="$4">
          ...
          <Separator />
          <Button chromeless onPress={() => console.log("Navigasi ke Syarat & Ketentuan")}>
            <Text color="$blue10">Syarat & Ketentuan</Text>
          </Button>
          <Button chromeless onPress={() => console.log("Navigasi ke Kebijakan Privasi")}>
